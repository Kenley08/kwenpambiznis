...
<head>
    ...
    <title>Kwenpam | Tablo b&ograve; | Estatistik | Pwodwi</title>
     <!-- Fontfaces CSS-->
    ...
    <link href="../../css/main.css?v=235" rel="stylesheet" media="all">
</head>
    ...
    <div class="page-wrapper">
        <div class="page-container2">
            ...
            <div class="section__content section__content--p30 midle-midle"> 
                ...
                <?php include '../../file/stat_product.inc.php'; include '../../file/footer.inc.php';?> 
            </div> 
        </div>
        <?php  
