<?php
    //nou start session 
    session_start();
    //nou verifye si konpayi livrezon an konekte deja
    if(!isset($_SESSION['id_delivery_company'])){
        header("location:../login/choice/?delivery");
    }
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Kwenpam | Dashboard | Delivery company</title>
     <!-- Fontfaces CSS-->
    ...
    <div class="page-wrapper">
        <div class="page-container2 index-page-container2">
            <?php
                ...
                include '../file/info_delivery.inc.php';
