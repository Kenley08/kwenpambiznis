...
class Constants{
    ...
    public static $REST_SANDBOX_ENDPOINT = "https://moncashbutton.digicelgroup.com/Api";

    public static $REST_LIVE_ENDPOINT = "https://moncashbutton.digicelgroup.com/Api";

    public static $SANDBOX_REDIRECT = "https://moncashbutton.digicelgroup.com/Moncash-middleware";
