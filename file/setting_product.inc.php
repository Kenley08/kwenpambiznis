    ...
    <div class="col-9">
            ...
            <div class="form-check">
                <div class="radio">
                    <label for="radio1" class="form-check-label">
                        <input type="radio" id="radio1" name="radios1" value="option1" class="form-check-input" checked>Wi
                    </label>
                </div>
                <div class="radio">
                    <label for="radio2" class="form-check-label">
                        <input type="radio" id="radio2" name="radios1" value="option2" class="form-check-input">Non
                    </label>
                </div> 
            </div>  <br> 
            <p>
            ...
            <div class="form-check">
                <div class="radio">
                    <label for="radio4" class="form-check-label ">
                        <input type="radio" id="radio4" name="radios" value="option4" class="form-check-input" checked>Wi (map jere livrezon an)
                    </label>
                </div>
                <div class="radio">
                    <label for="radio3" class="form-check-label ">
                        <input type="radio" id="radio3" name="radios" value="option3" class="form-check-input" checked>Wi (kwenpam biznis ap jere sa)
                    </label>
                </div>
                <div class="radio">
                    <label for="radio5" class="form-check-label ">
                        <input type="radio" id="radio5" name="radios" value="option2" class="form-check-input">Non
                    </label>
                </div> 
            </div> 
        </div> <br> 
        <div class="text-pub" id="step-1-new-ads">  
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <textarea type="email" rows="5" name="txtdescriptionliv" required placeholder="Ex: Nou pa responsab si tout fwa le pwodwi an fin livre, selon garanti li genyen, li vin kraze." class="form-control"></textarea>
                    <!-- <small class="help-block form-text">Please enter your email</small> -->
                </div>
            </div>  
        </div> <br>   
        <a href="../"  class="btn btn-secondary btn-small">Anile </a> 
        <input type="submit" class="btn btn-primary btn-small" value="Kotinye" name="btncontinuer"/> 
    </div> 
</form>