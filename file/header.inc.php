        ...
        <div class="container-fluid">
            <div class="header-wrap2">
                <div class="logo d-block d-lg-none">
                    <a href="#">
                        <img src="https://kwenpam.com/business/images/delivery/bridgexpress.jpg" alt="livrezon logo" style=" height:50px!important;"/>
                    </a>
                </div>
    ...
    <?php 
        if(isset($_SESSION['id_delivery_company'])){?>
            <aside class="menu-sidebar2 js-right-sidebar d-block d-lg-none">
                <div class="logo">
                    <a href="#">
                        <!-- <img src="https://kwenpam.com/business/images/delivery/bridgexpress.jpg" alt="livrezon logo" /> -->
                    </a>
                </div>
                        ...
                        <ul class="list-unstyled navbar__list">
                            <li class="active has-sub">
                                ...
                                <ul class="list-unstyled navbar__sub-list js-sub-list">
                                    <li>
                                        <a href="https://kwenpam.com/business/delivery/account/">
                                            <i class="fas"></i>Modifye kont</a>
                                    </li>
                                    <li>
                                        <a href="https://kwenpam.com/business/delivery/pin/">
